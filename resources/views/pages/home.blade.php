					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<div class="feature-icon"><img src="/img/icon-pie-chart.png" alt="" class="icon"></div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<div class="feature-icon"><img src="/img/icon-mobile.png" alt="" class="icon"></div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<div class="feature-icon"><img src="/img/icon-piggy-bank.png" alt="" class="icon"></div>
							...
							<div class="col-md-3 col-sm-6">
								<div class="feature">
									<div class="feature-icon"><img src="/img/icon-lock.png" alt="" class="icon"></div>
